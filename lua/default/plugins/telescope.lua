return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>gc", require("telescope.builtin").git_commits, { desc = "Find git commits" })
			vim.keymap.set("n", "<leader>gb", require("telescope.builtin").git_branches, { desc = "Find git branches" })
			vim.keymap.set(
				"n",
				"<leader>gs",
