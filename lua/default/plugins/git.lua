return {
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>gl", require("gitsigns").blame, { desc = "Open git blame panel" })
			vim.keymap.set("n", "<leader>gll", require("gitsigns").blame_line, { desc = "See git blame inline" })
			vim.keymap.set(
				"n",
				"<leader>ghh",
